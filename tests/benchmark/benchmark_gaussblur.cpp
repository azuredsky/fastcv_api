...
void benchmark(int inputWidth, int inputHeight){
    ...
    refrensh();
    if(diameter == 3){
        show(gaussblur-d-3_u_1);
    }
    if(diameter == 5){
        show(gaussblur-d-5_u_1);
    }
    if(diameter == 7){
        show(gaussblur-d-7_u_1);
    }
    show_(inputWidth);
    gettime((gaussianBlur<uchar, diameter, 1, 1, 1>(u1_1, &u1_2)));
    gettime_opencv((cv::GaussianBlur(o_u1_1, o_u1_2, ksize, -1, -1)));


    if(diameter == 3){
        show(gaussblur-d-3_u_3);
    }
    if(diameter == 5){
        show(gaussblur-d-5_u_3);
    }
    if(diameter == 7){
        show(gaussblur-d-7_u_3);
    }
    show_(inputWidth);
    gettime((gaussianBlur<uchar, diameter, 3, 3, 3>(u3_1, &u3_2)));
    gettime_opencv((cv::GaussianBlur(o_u3_1, o_u3_2, ksize, -1, -1)));


    if(diameter == 3){
        show(gaussblur-d-3_u_4);
    }
    if(diameter == 5){
        show(gaussblur-d-5_u_4);
    }
    if(diameter == 7){
        show(gaussblur-d-7_u_4);
    }
    show_(inputWidth);
    gettime((gaussianBlur<uchar, diameter, 4, 4, 4>(u4_1, &u4_2)));
    gettime_opencv((cv::GaussianBlur(o_u4_1, o_u4_2, ksize, -1, -1)));
    }


    if(diameter == 3 || diameter == 5){
    refrensh();
    if(diameter == 3){
        show(gaussblur-d-3_f_1);
    }
    if(diameter == 5){
        show(gaussblur-d-5_f_1);
    }
    if(diameter == 7){
        show(gaussblur-d-7_f_1);
    }
    show_(inputWidth);
    gettime((gaussianBlur<float, diameter, 1, 1, 1>(f1_1, &f1_2)));
    gettime_opencv((cv::GaussianBlur(o_f1_1, o_f1_2, ksize, -1, -1)));


    if(diameter == 3){
        show(gaussblur-d-3_f_3);
    }
    if(diameter == 5){
        show(gaussblur-d-5_f_3);
    }
    if(diameter == 7){
        show(gaussblur-d-7_f_3);
    }
    show_(inputWidth);
    gettime((gaussianBlur<float, diameter, 3, 3, 3>(f3_1, &f3_2)));
    gettime_opencv((cv::GaussianBlur(o_f3_1, o_f3_2, ksize, -1, -1)));


    if(diameter == 3){
        show(gaussblur-d-3_f_4);
    }
    if(diameter == 5){
        show(gaussblur-d-5_f_4);
    }
    if(diameter == 7){
        show(gaussblur-d-7_f_4);
    }
    show_(inputWidth);
    gettime((gaussianBlur<float, diameter, 4, 4, 4>(f4_1, &f4_2)));
    gettime_opencv((cv::GaussianBlur(o_f4_1, o_f4_2, ksize, -1, -1)));
    }
...
int main(){
    ...
    benchmark<5>(640, 480);
    benchmark<5>(1280, 720);
    benchmark<5>(1920, 1080);
    benchmark<7>(640, 480);
    benchmark<7>(1280, 720);
    benchmark<7>(1920, 1080);
}
