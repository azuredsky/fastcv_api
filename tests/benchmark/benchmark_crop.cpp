...
void benchmark(int inputWidth, int inputHeight, int outputWidth, int outputHeight){
    ...
    cv::Rect myROI(12, 22, outputWidth, outputHeight);
    Point2i p(12, 22);
    ...
    show(crop_u_1);
    show_(inputWidth);
    gettime((crop<uchar, 1, uchar, 1, 1>(u1_1, p, (uchar)1, &u1_d1)));
    gettime_opencv((o_u1_d1=o_u1_1(myROI).clone()));

    show(crop_u_3);
    show_(inputWidth);
    gettime((crop<uchar, 3, uchar, 3, 3>(u3_1, p, (uchar)1, &u3_d1)));
    gettime_opencv((o_u3_d1=o_u3_1(myROI).clone()));

    show(crop_u_4);
    show_(inputWidth);
    gettime((crop<uchar, 4, uchar, 4, 4>(u4_1, p, (uchar)1, &u4_d1)));
    gettime_opencv((o_u4_d1=o_u4_1(myROI).clone()));

    show(crop_f_1);
    show_(inputWidth);
    gettime((crop<float, 1, float, 1, 1>(f1_1, p, (float)1, &f1_d1)));
    gettime_opencv((o_f1_d1=o_f1_1(myROI).clone()));

    show(crop_f_3);
    show_(inputWidth);
    gettime((crop<float, 3, float, 3, 3>(f3_1, p, (float)1, &f3_d1)));
    gettime_opencv((o_f3_d1=o_f3_1(myROI).clone()));

    show(crop_f_4);
    show_(inputWidth);
    gettime((crop<float, 4, float, 4, 4>(f4_1, p, (float)1, &f4_d1)));
    gettime_opencv((o_f4_d1=o_f4_1(myROI).clone()));

    
}

int main(){
    benchmark(640, 480, 320, 240);
    benchmark(1280, 720, 640, 360);
    benchmark(1920, 1080, 960, 540);
}
